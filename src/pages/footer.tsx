...
export default function Footer() {
  return (
    <div className="py-5">
      <footer className="bg-[#71C9CE] text-white rounded-lg p-8 flex justify-between items-center">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <p className=" text-sm">+62812345678</p>
              <p className=" text-sm">menon@gmail.com</p>
          ...
          <div className="mt-8 pt-8 border-t-[1px] border-white  text-center">
            <p>Copyright©2024 menon Corp. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </div>
